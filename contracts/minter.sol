...
contract Cantofornia is ERC721, ERC721Enumerable, ERC721Burnable, Ownable, ERC2981 {
    ...
    // Supply tracking
    uint256 public constant maxTokenSupply = 1848;
    ...
    uint256 internal preFillBase = 600;
    ...
    constructor(uint256 _unlockCliff, uint256 _unlockPeriod, uint8 _unlockPercent, uint8 _teamSplit, address _teamAddress) ERC721("Cantofornia", "CTS") {
        splitter = new Splitter(_unlockCliff, _unlockPeriod, _unlockPercent, _teamSplit, _teamAddress);
